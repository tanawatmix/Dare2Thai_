              ...
              {currentPage > 1 && (
                <>
                  <button
                    ...
                    className="px-3 py-1 border rounded transition-all duration-300 hover:bg-pink-400 hover:text-white"
                  >
                    {"<<"}
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className={`px-3 py-1 border rounded font-semibold ${
                      currentPage === pageNumber
                        ...
                        : "bg-primary border text-secondary hover:border-pink-400 hover:bg-pink-100"
                    } transition duration-300 dark:bg-secondary dark:text-primary dark:hover:bg-pink-400`}
                  >
                    {pageNumber}
                  </button>
                );
              ...
              {currentPage < totalPages && (
                <>
                  <button
                    ...
                    className="px-3 py-1 rounded border transition-all duration-300 hover:bg-pink-400 hover:text-white"
                  >
                    {">"}
                  </button>
                  <button
